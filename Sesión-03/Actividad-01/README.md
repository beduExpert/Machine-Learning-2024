# **Actividad 01 - Aplicación de Regresión Logística para Determinar el Precio de un Seguro**
...
## 📑 Instrucciones
1. Con la ayuda del profesor, ejecuta el siguiente [Programa]()
2.	Utiliza el código de la [actividad 03](Actividad 01 - Simple Linear Regression - Insurance.ipynb)
3.	Analiza bien las variables para saber cuáles son las más relevantes
